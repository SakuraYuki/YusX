...
VALUES
    (1, 'CommonHas', '有无值', 0, 1, 0, NULL, NULL, 1, '超级管理员', NOW())
    ,(2, 'CommonYesNo', '是否值', 0, 1, 0, NULL, NULL, 1, '超级管理员', NOW())
    ,(3, 'CommonEnable', '启用状态', 0, 1, 0, NULL, NULL, 1, '超级管理员', NOW())
    ,(4, 'CommonGender', '性别', 0, 1, 0, NULL, NULL, 1, '超级管理员', NOW())
    ,(5, 'CommonGenderSecret', '性别(含保密)', 0, 1, 0, NULL, NULL, 1, '超级管理员', NOW())
    ,(6, 'CommonExpire', '过期状态', 0, 1, 0, NULL, NULL, 1, '超级管理员', NOW())
    ,(7, 'CommonAuditStatus', '审核状态', 0, 1, 0, NULL, NULL, 1, '超级管理员', NOW())
    ,(8, 'CommonRoleList', '角色列表', 0, 1, 0, NULL, 'SELECT RoleId as `key`, RoleName as `value` FROM Sys_Role WHERE Enable = 1', 1, '超级管理员', NOW())
    ,(9, 'CommonRoleTree', '级联角色', 0, 1, 0, NULL, 'SELECT RoleId AS `id`, parentId, RoleId AS `key`, RoleName AS `value` FROM Sys_Role WHERE Enable = 1', 1, '超级管理员', NOW())
    ,(10, 'CommonProvinceList', '省份列表', 0, 1, 0, NULL, 'SELECT ProvinceCode AS `key`, ProvinceName AS `value` FROM Sys_Province', 1, '超级管理员', NOW())
    ,(11, 'CommonCityList', '城市列表', 0, 1, 0, NULL, 'SELECT CityCode AS `key`, CityName AS `value` FROM Sys_City', 1, '超级管理员', NOW())
    ,(12, 'CommonCountyList', '区县列表', 0, 1, 0, NULL, 'SELECT CountyCode AS `key`, CountyName AS `value` FROM Sys_County', 1, '超级管理员', NOW())
    ,(100, 'SysLogLogType', '日志类型', 0, 1, 0, NULL, NULL, 1, '超级管理员', NOW())
    ,(101, 'SysLogLevel', '日志级别', 0, 1, 0, NULL, NULL, 1, '超级管理员', NOW())
    ,(102, 'SysApiLogResponseStatus', '接口日志响应状态', 0, 1, 0, NULL, NULL, 1, '超级管理员', NOW())
    ,(103, 'SysApiLogType', '接口日志类型', 0, 1, 0, NULL, NULL, 1, '超级管理员', NOW())
    ,(104, 'SysUserLogType', '用户日志类型', 0, 1, 0, NULL, NULL, 1, '超级管理员', NOW())
    ,(105, 'SysTokenType', '令牌类型', 0, 1, 0, NULL, NULL, 1, '超级管理员', NOW())
    ,(106, 'SysTokenCodeType', '令牌代码类型', 0, 1, 0, NULL, NULL, 1, '超级管理员', NOW())
...
VALUES
    -- 有无值
    (1, '无', '0', 1, 100, NULL, 1, '超级管理员', NOW())
    ,(1, '有', '1', 1, 95, NULL, 1, '超级管理员', NOW())
    -- 是否值
    ,(2, '否', '0', 1, 100, NULL, 1, '超级管理员', NOW())
    ,(2, '是', '1', 1, 95, NULL, 1, '超级管理员', NOW())
    -- 启用状态
    ,(3, '禁用', '0', 1, 100, NULL, 1, '超级管理员', NOW())
    ,(3, '启用', '1', 1, 95, NULL, 1, '超级管理员', NOW())
    -- 性别
    ,(4, '男', '0', 1, 100, NULL, 1, '超级管理员', NOW())
    ,(4, '女', '1', 1, 95, NULL, 1, '超级管理员', NOW())
    -- 性别(含保密)
    ,(5, '男', '0', 1, 100, NULL, 1, '超级管理员', NOW())
    ,(5, '女', '1', 1, 95, NULL, 1, '超级管理员', NOW())
    ,(5, '保密', '2', 1, 90, NULL, 1, '超级管理员', NOW())
    -- 过期状态
    ,(6, '已过期', '0', 1, 100, NULL, 1, '超级管理员', NOW())
    ,(6, '未过期', '1', 1, 95, NULL, 1, '超级管理员', NOW())
    -- 审核状态
    ,(7, '待审核', '0', 1, 100, NULL, 1, '超级管理员', NOW())
    ,(7, '已审核', '1', 1, 95, NULL, 1, '超级管理员', NOW())
    ,(7, '未通过', '2', 1, 90, NULL, 1, '超级管理员', NOW())
    -- 日志类型
    ,(100, '其他', '0', 1, 100, NULL, 1, '超级管理员', NOW())
    ,(100, '服务', '1', 1, 95, NULL, 1, '超级管理员', NOW())
    ,(100, '数据库', '2', 1, 90, NULL, 1, '超级管理员', NOW())
    ,(100, '系统接口', '3', 1, 85, NULL, 1, '超级管理员', NOW())
    ,(100, '应用接口', '4', 1, 80, NULL, 1, '超级管理员', NOW())
    -- 日志级别
    ,(101, '冗余', '0', 1, 100, NULL, 1, '超级管理员', NOW())
    ,(101, '调试', '1', 1, 95, NULL, 1, '超级管理员', NOW())
    ,(101, '信息', '2', 1, 90, NULL, 1, '超级管理员', NOW())
    ,(101, '警告', '3', 1, 85, NULL, 1, '超级管理员', NOW())
    ,(101, '错误', '4', 1, 80, NULL, 1, '超级管理员', NOW())
    ,(101, '致命', '5', 1, 75, NULL, 1, '超级管理员', NOW())
    -- 接口日志响应状态
    ,(102, '其他', '0', 1, 100, NULL, 1, '超级管理员', NOW())
    ,(102, '成功', '1', 1, 95, NULL, 1, '超级管理员', NOW())
    ,(102, '异常', '2', 1, 90, NULL, 1, '超级管理员', NOW())
    ,(102, '信息', '3', 1, 85, NULL, 1, '超级管理员', NOW())
    -- 接口日志类型
    ,(103, '其他', '0', 1, 100, NULL, 1, '超级管理员', NOW())
    ,(103, '系统', '1', 1, 95, NULL, 1, '超级管理员', NOW())
    ,(103, '登录', '2', 1, 90, NULL, 1, '超级管理员', NOW())
    ,(103, '新增', '3', 1, 85, NULL, 1, '超级管理员', NOW())
    ,(103, '编辑', '4', 1, 80, NULL, 1, '超级管理员', NOW())
    ,(103, '删除', '5', 1, 75, NULL, 1, '超级管理员', NOW())
    ,(103, '修改密码', '6', 1, 70, NULL, 1, '超级管理员', NOW())
    ,(103, '刷新Token', '7', 1, 65, NULL, 1, '超级管理员', NOW())
    ,(103, 'Token过期', '8', 1, 60, NULL, 1, '超级管理员', NOW())
    ,(103, '应用接口', '9', 1, 55, NULL, 1, '超级管理员', NOW())
    ,(103, '系统接口异常', '10', 1, 50, NULL, 1, '超级管理员', NOW())
    ,(103, '应用接口异常', '11', 1, 45, NULL, 1, '超级管理员', NOW())
    -- 用户日志类型
    ,(104, '登录', '1', 1, 100, NULL, 1, '超级管理员', NOW())
    ,(104, '修改密码', '2', 1, 95, NULL, 1, '超级管理员', NOW())
    -- 令牌类型
    ,(105, '用户', '1', 1, 100, NULL, 1, '超级管理员', NOW())
    ,(105, '开发', '2', 1, 95, NULL, 1, '超级管理员', NOW())
    ,(105, '任务', '3', 1, 90, NULL, 1, '超级管理员', NOW())
    -- 令牌代码类型
    ,(106, 'ID', '1', 1, 100, NULL, 1, '超级管理员', NOW())
    ,(106, '用户名', '2', 1, 95, NULL, 1, '超级管理员', NOW())
    ,(106, '邮箱', '3', 1, 90, NULL, 1, '超级管理员', NOW())
    ,(106, '手机号', '4', 1, 85, NULL, 1, '超级管理员', NOW())
...
VALUES
    (1, '开发中心', 0, 'ivu-icon ivu-icon-md-construct', NULL, 1, 3000, NULL, '/Coding', '[{\"text\":\"查询\",\"value\":\"Search\"}]', 1, '超级管理员', NOW())
    ,(100, '代码生成', 1, 'ivu-icon ivu-icon-ios-hammer', NULL, 1, 2990, NULL, '/Coder', '[{\"text\":\"查询\",\"value\":\"Search\"}]', 1, '超级管理员', NOW())
    ,(2, '用户权限', 0, 'ivu-icon ivu-icon-ios-people', NULL, 1, 2000, NULL, '', '[{\"text\":\"查询\",\"value\":\"Search\"}]', 1, '超级管理员', NOW())
    ,(200, '用户管理', 2, 'ivu-icon ivu-icon-ios-person', NULL, 1, 1990, 'Sys_User', '/SysUser', '[{\"text\":\"查询\",\"value\":\"Search\"},{\"text\":\"新建\",\"value\":\"Add\"},{\"text\":\"删除\",\"value\":\"Delete\"},{\"text\":\"编辑\",\"value\":\"Update\"},{\"text\":\"导入\",\"value\":\"Import\"},{\"text\":\"导出\",\"value\":\"Export\"},{\"text\":\"上传\",\"value\":\"Upload\"},{\"text\":\"审核\",\"value\":\"Audit\"}]', 1, '超级管理员', NOW())
    ,(201, '角色管理', 2, 'ivu-icon ivu-icon-ios-contacts', NULL, 1, 1990, 'Sys_Role', '/SysRole', '[{\"text\":\"查询\",\"value\":\"Search\"},{\"text\":\"新建\",\"value\":\"Add\"},{\"text\":\"删除\",\"value\":\"Delete\"},{\"text\":\"编辑\",\"value\":\"Update\"},{\"text\":\"导出\",\"value\":\"Export\"}]', 1, '超级管理员', NOW())
    ,(202, '权限管理', 2, 'ivu-icon ivu-icon-ios-boat', NULL, 1, 1980, 'Sys_Role2', '/Permission', '[{\"text\":\"查询\",\"value\":\"Search\"},{\"text\":\"编辑\",\"value\":\"Update\"}]', 1, '超级管理员', NOW())
    ,(3, '系统管理', 0, 'ivu-icon ivu-icon-md-settings', NULL, 1, 1000, NULL, '', '[{\"text\":\"查询\",\"value\":\"Search\"}]', 1, '超级管理员', NOW())
    ,(300, '菜单设置', 3, 'ivu-icon ivu-icon-ios-menu', NULL, 1, 990, 'Sys_Menu', '/SysMenu', '[{\"text\":\"查询\",\"value\":\"Search\"},{\"text\":\"新建\",\"value\":\"Add\"},{\"text\":\"编辑\",\"value\":\"Update\"}]', 1, '超级管理员', NOW())
    ,(301, '字典维护', 3, 'ivu-icon ivu-icon-ios-book', NULL, 1, 980, 'Sys_Dictionary', '/SysDictionary', '[{\"text\":\"查询\",\"value\":\"Search\"},{\"text\":\"新建\",\"value\":\"Add\"},{\"text\":\"删除\",\"value\":\"Delete\"},{\"text\":\"编辑\",\"value\":\"Update\"},{\"text\":\"导出\",\"value\":\"Export\"}]', 1, '超级管理员', NOW())
    ,(302, '接口日志', 3, 'ivu-icon ivu-icon-ios-magnet', NULL, 1, 970, 'Sys_ApiLog', '/SysApiLog', '[{\"text\":\"查询\",\"value\":\"Search\"},{\"text\":\"删除\",\"value\":\"Delete\"},{\"text\":\"导出\",\"value\":\"Export\"}]', 1, '超级管理员', NOW())
    ,(303, '系统日志', 3, 'ivu-icon ivu-icon-ios-paper', NULL, 1, 960, 'Sys_Log', '/SysLog', '[{\"text\":\"查询\",\"value\":\"Search\"},{\"text\":\"删除\",\"value\":\"Delete\"},{\"text\":\"导出\",\"value\":\"Export\"}]', 1, '超级管理员', NOW())
    ,(304, '标志管理', 3, 'ivu-icon ivu-icon-ios-flag', NULL, 1, 950, 'Sys_Flag', '/SysFlag', '[{\"text\":\"查询\",\"value\":\"Search\"},{\"text\":\"新建\",\"value\":\"Add\"},{\"text\":\"删除\",\"value\":\"Delete\"},{\"text\":\"编辑\",\"value\":\"Update\"},{\"text\":\"导出\",\"value\":\"Export\"}]', 1, '超级管理员', NOW())
...
VALUES
    (1, '用户权限', 0, NULL, NULL, NULL, NULL, 'System', 'Yus.System', 1, 2000, NULL, NULL, NULL, 0)
...
VALUES
    (1, '管理部', 0, NULL, 1, 1000, NULL, 1, '超级管理员', NOW())
    ,(2, '财务部', 0, NULL, 1, 950, NULL, 1, '超级管理员', NOW())
    ,(3, '研发部', 0, NULL, 1, 900, NULL, 1, '超级管理员', NOW())
    ,(4, '销售部', 0, NULL, 1, 850, NULL, 1, '超级管理员', NOW())
    ,(5, '服务部', 0, NULL, 1, 800, NULL, 1, '超级管理员', NOW())
...
VALUES
    (1, 'admin', '超级管理员', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, 'DB7A7770B8A653BF9C6953E9927BD0EF', '5E9D4F4711D84682B33DA43C55E4A94E', 1, 1, '超级管理员', NOW(), 1, '超级管理员', NOW()),
    ,(2, 'test', '测试用户', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, 'BF7D16B928EE104C200855F60D980FF5', '3195EB1788374D078A3317FB3C15B3AB', 1, 1, '超级管理员', NOW(), 1, '超级管理员', NOW())
...
VALUES
    (1, '超级管理员', 0, 1, 50, NULL, 1, '超级管理员', NOW())
    ,(2, '系统管理员', 0, 1, 100, NULL, 1, '超级管理员', NOW())
    ,(3, '开发者', 0, 1, 150, NULL, 1, '超级管理员', NOW())
    ,(4, '测试员', 0, 1, 200, NULL, 1, '超级管理员', NOW())
    ,(5, '管理人员', 0, 1, 300, NULL, 1, '超级管理员', NOW())
    ,(6, '工作人员', 0, 1, 250, NULL, 1, '超级管理员', NOW())
    ,(7, '系统演示', 0, 1, 0, NULL, 1, '超级管理员', NOW())
