...
namespace YusX.Core.BaseProvider
{
    public interface IService<T> where T : BaseEntity
    {
        ...
        /// <returns></returns>
        PaginationResult<T> GetPageData(PaginationOptions pageData);

        object GetDetailPage(PaginationOptions pageData);
        ...
        /// <param name="pageData"></param>
        /// <returns></returns>
        WebResponseContent Export(PaginationOptions pageData);
        ...
        /// <returns></returns>
        WebResponseContent Add(SaveDataModel saveDataModel);
        ...
        /// <param name="saveDataModel">主表与子表的数据</param>
        /// <returns></returns>
        WebResponseContent Update(SaveDataModel saveDataModel);
