...
namespace YusX.Core.Providers
{
    ...
    public interface IRepository<TEntity> where TEntity : BaseEntity
    {
        ...
        /// </param>
        /// <returns></returns>
        IQueryable<TEntity> FindAsIQueryable(
            Expression<Func<TEntity, bool>> predicate,
            Expression<Func<TEntity, Dictionary<object, QueryOrderBy>>> orderBy = null);
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        List<TFind> Find<TFind>(Expression<Func<TFind, bool>> predicate)
            where TFind : class;

        Task<TFind> FindAsyncFirst<TFind>(Expression<Func<TFind, bool>> predicate)
            where TFind : class;

        Task<TEntity> FindAsyncFirst(Expression<Func<TEntity, bool>> predicate);

        Task<List<TFind>> FindAsync<TFind>(Expression<Func<TFind, bool>> predicate)
            where TFind : class;
        ...
        /// <returns></returns>
        List<TResult> Find<Source, TResult>(
            IEnumerable<Source> sources,
            Func<Source, Expression<Func<TEntity, bool>>> predicate,
        ...
        /// <param name="predicate">生成的查询条件</param>
        /// <returns></returns>
        IQueryable<TEntity> FindAsIQueryable<Source>(
            IEnumerable<Source> sources,
            Func<Source, Expression<Func<TEntity, bool>>> predicate)
            where Source : class;
        ...
        bool Exists<TExists>(Expression<Func<TExists, bool>> predicate)
            where TExists : class;

        Task<bool> ExistsAsync<TExists>(Expression<Func<TExists, bool>> predicate)
            where TExists : class;
        ...
        /// <returns></returns>
        List<TResult> QueryByPage<TResult>(
            int pageIndex,
            int pagesize,
            out int rowcount,
            Expression<Func<TEntity, bool>> predicate,
            Expression<Func<TEntity, Dictionary<object, QueryOrderBy>>> orderBySelector,
        ...
        IQueryable<TFind> IQueryablePage<TFind>(
            int pageIndex,
            int pagesize,
            out int rowcount,
        ...
        IQueryable<TEntity> IQueryablePage(
        ...
        /// <returns></returns>
        IQueryable<TEntity> FromSqlInterpolated([NotNull] FormattableString sql);
