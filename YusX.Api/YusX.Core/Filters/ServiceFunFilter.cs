...
namespace YusX.Core.Filters
{
    public  abstract class ServiceFunFilter<T> where T : class
    {
        ...
        /// </summary>
        protected Action<List<SearchOptions>> QueryRelativeList { get; set; }
        ...
        /// 页面查询或导出，从数据库查询出来的结果
        /// </summary>
        protected Action<PaginationResult<T>> GetPageDataOnExecuted;

        /// <summary>
        /// 调用新建处理前(SaveModel为传入的原生数据)
        /// </summary>
        protected Func<SaveDataModel, WebResponseContent> AddOnExecute;
        ...
        /// </summary>
        protected Func<SaveDataModel, WebResponseContent> UpdateOnExecute;
